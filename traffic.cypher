...
// Find the FASTEST path using hardcoded names
...
// Call GDS Dijkstra on the projected graph
...
// Use the path object to directly extract coordinates and properties
WITH totalCost,
...
RETURN route_coords AS route,
       totalCost / 60.0 AS estimated_minutes, // This will now be a valid number
       congestion_history,
       CASE
